...
class TacticalViewConverter:
    def __init__(self, court_image_path):
        ...
        self.width = 300      # pixel width of tactical view
        self.height = 161     # pixel height of tactical view
        self.actual_width_in_meters = 28   # real-world court width in meters
        self.actual_height_in_meters = 15  # real-world court height in meters

        #0.9-> actual hieght in mtrs - 15
        self.key_points = [
        # left edge
        (0,0),
        ...
        for frame_idx, (frame_keypoints, frame_tracks) in enumerate(zip(keypoints_list, player_tracks)):
            ...
            try:
                ...
                for player_id, player_data in frame_tracks.items():
                    ...
                    player_position = np.array([get_foot_positions(bbox)])
